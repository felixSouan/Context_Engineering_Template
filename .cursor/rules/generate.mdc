...
Note that some projects might be simpler and might not require every one of these aspects. It is therefore acceptable to remove some of the bullets in a stage if the project does not need it.
